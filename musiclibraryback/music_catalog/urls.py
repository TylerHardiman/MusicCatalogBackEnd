...
urlpatterns = [
  path('music/', views.MusicDetail.as_view()), #as_view calling underlying method inside APIView that class-based views inherit from
  path('music/<int:pk>/', views.MusicRetrieve.as_view())
  #path('music/<int:pk>/update/', views.MusicRetrieve.as_view())
]
